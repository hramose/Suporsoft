...
<head>
  ...
  <title>Supporsoft - Dashboard</title>
      ...
      <nav class="navbar navbar-transparent navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="./"><b>Sistema de Requerimientos</b></a>
          </div>
      ...
      <footer class="footer">
        ...
        <!--
          ...
          <p class="copyright pull-right">
            <a href="http://www.communitysw.com" target="_blank">Comsoft México</a> &copy; 2017
          </p>
        </div>
      </footer>
    </div>
